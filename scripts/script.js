...
const kangaroo = new Animal("Kangaroo", "image", "Kangaroos are marsupials from the subfamily Macropodinae (macropods, meaning of large foot). In common use, the term is used to describe the largest species from this family, the red kangaroo, as well as the antilopine kangaroo, eastern grey kangaroo, and western grey kangaroo.[1] Kangaroos are indigenous to Australia and New Guinea. The Australian government estimates that 42.8 million kangaroos lived within the commercial harvest areas of Australia in 2019, down from 53.2 million in 2013.[2]", "Plant eaters, they munch on shrubs and grasses", "Mammal", "mammals.html");
